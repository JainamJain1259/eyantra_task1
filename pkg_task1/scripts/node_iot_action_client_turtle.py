...
class SimpleActionClientTurtle:
    ...
    def done_callback(self, status, result):
        ...
        parameters = {"id":"sheet1", "team_id":1089, "unique_id":"jtkjabcd", "turtle_x": str(result.final_x), "turtle_y": str(result.final_y), "turtle_theta":str(result.final_theta)} 
        URL = "https://script.google.com/macros/s/AKfycbyYuaeHjwQ-n9v31nIHK19gSJS6rCDRhI9Pjns27o6Z13_RhVE/exec"
